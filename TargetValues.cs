...
namespace RandomNumberGenerator
{
    ...
    internal static class TargetValues
    {
        ...
        internal static string ToString(int iTargetValue)
        {
        ...
        internal static int ToInt(string sTargetValue)
        {
        ...
        internal static string GetStringAt(uint iIndex)
        {
            string sResult = null;
        ...
        internal static int GetValueAt(uint iIndex)
        {
            int iResult = NO_VALUE_SET;
        ...
        /// </summary>
        internal const int NO_VALUE_SET = -2;

        /// <summary>
        /// The list of string representations of the possible values set
        /// </summary>
        internal static string[] TargetStrings { get; } = { "None", "0", "1" }; // string respresentation of possible targets
